...
const tracks1 = [
  { src: "../Page4/mediafile/Aerials.mp3", title: "Aerials - System of a Down" },
  { src: "../Page4/mediafile/Toxicity.mp3", title: "Toxicity - System of a Down" }
...
const tracks2 = [
  { src: "../Page4/mediafile/Kickstarts.mp3", title: "Example - Kickstarts (Bar 9 Remix)" },
  { src: "../Page4/mediafile/Discover_Life.mp3", title: "Discover Life - Uppermost" }
];
...
const tracks3 = [
  { src: "../Page4/mediafile/If_not_winter.mp3", title: "if not winter - Wisp" },
  { src: "../Page4/mediafile/Lone_Wolf_Hysteria.mp3", title: "Lone Wolf Hysteria - $uicideboy$" },
  { src: "../Page4/mediafile/Deathwish.mp3", title: "Deathwish - akikura" },
  { src: "../Page4/mediafile/Ghosts.mp3", title: "Ghosts - Anizyz" }
];
